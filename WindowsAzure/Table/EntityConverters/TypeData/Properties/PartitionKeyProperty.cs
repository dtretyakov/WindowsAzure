...
namespace WindowsAzure.Table.EntityConverters.TypeData.Properties
{
    ...
    internal sealed class PartitionKeyProperty<T> : IProperty<T>
    {
        ...
        internal PartitionKeyProperty(MemberInfo member)
        {
            if (member == null)
            {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(member), Resources.PropertyPartitionKeyInvalidType);
            }
