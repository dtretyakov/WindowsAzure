...
namespace WindowsAzure.Tests.Table.RequestExecutor
{
    public sealed class SequentialExecutorTests
    {
        ...
        public void CreateExecutorWithNullCloudTableParameter()
        {
            ...
            // Act && Assert
            Assert.Throws<ArgumentNullException>(() => new TableRequestSequentialExecutor<Country>(null, entityConverterMock.Object));
        }
        ...
        public void CreateExecutorWithNullEntityConverterParameter()
        {
            ...
            // Act && Assert
            Assert.Throws<ArgumentNullException>(() => new TableRequestSequentialExecutor<Country>(cloudTable, null));
        }
